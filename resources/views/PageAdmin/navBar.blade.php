...
<div class="navbar">
    <!-- logo univ-->
    <img src="{{asset('asset\assets\univ2-logo.png')}}" alt="univ2-logo" class="logo">
    <nav>
        <ul>
    ...
    <div class="logout-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="38.556" height="52.881" viewBox="0 0 60 52.881">
